...
- **正确示例**: `messages` 字段 ([state.py:39](backend/app/multi_agent/workflow/state.py#L39))
- **修复位置**: `retrieved_documents` 字段 ([state.py:58](backend/app/multi_agent/workflow/state.py#L58))
- **并行节点**: 搜索节点 ([search_nodes.py](backend/app/multi_agent/workflow/nodes/search_nodes.py))
