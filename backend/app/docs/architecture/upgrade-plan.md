# ⚠️ [已废弃] ITS 多智能体系统架构升级与演进规划书 (v1.0)

> **状态: 已废弃** | 替代文档: [upgrade-plan-v2.md](upgrade-plan-v2.md)
>
> 本文档提出的 Supervisor-Worker 全面重构方案未被采纳。实际系统选择了显式编排管道（LangGraph v1.4），
> 并在此基础上规划了"外层管道 + 内层自主循环"的混合架构升级路线。
> 保留本文档仅作为架构决策的历史参考。
